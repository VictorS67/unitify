      ...
      <View style={styles.tripCardContent}>
        ...
        <View style={styles.flexColumn}>
          ...
          <Text style={styles.cardText}>
            ...
            <Text>&nbsp;h&nbsp;</Text>
            <Text style={styles.statText}>{minute}</Text>
            <Text>&nbsp;min</Text>
          </Text>
        </View>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Are you sure you want to finish your trip? Complete this action
                will save your current trip records and stop navigation.
              </Text>
            </View>
