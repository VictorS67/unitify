  ...
  const onSwitchPress = () => {
    if (
      ...
      if (main.navStatus !== "NAV") {
        ...
        dispatch(
          updateAllDirection(destination_info, origin_info, map.travalMode)
        ).then(() => {
  ...
  const onSearchPress = async () => {
    if (
      ...
      if (
        ...
        text === map.destination.address_simple
      ) {
      ...
      try {
        ...
        if (
          ...
          if (
            map.origin &&
            map.origin.address_simple &&
            text === map.origin.address_simple
          ) {
          ...
          dispatch(
            updateAllDirection(map.position, destinationLocInfo, map.travalMode)
          ).then(() => {
            dispatch(mapActions.updatingInfoComplete());
          });
        }
      ...
      >
        ...
        >
          <TouchableOpacity
            style={[
              styles.buttonSquare,
              map.travalMode === "DRIVING" && styles.buttonActive,
            ]}
            onPress={() => onTravalModePress("DRIVING")}
          >
            <FontAwesome5
              name="car"
              size={normalize(14)}
          ...
          <TouchableOpacity
            style={[
              styles.buttonSquare,
              map.travalMode === "WALKING" && styles.buttonActive,
            ]}
            onPress={() => onTravalModePress("WALKING")}
          >
            <FontAwesome5
              name="walking"
              size={normalize(14)}
          ...
          <TouchableOpacity
            style={[
              styles.buttonSquare,
              map.travalMode === "SUBWAY" && styles.buttonActive,
            ]}
            onPress={() => onTravalModePress("SUBWAY")}
          >
            <FontAwesome5
              name="subway"
              size={normalize(14)}
          ...
          <TouchableOpacity
            style={[
              styles.buttonSquare,
              map.travalMode === "BUS" && styles.buttonActive,
            ]}
            onPress={() => onTravalModePress("BUS")}
          >
            <FontAwesome5
              name="bus"
              size={normalize(14)}
              color={theme.colors.text}
            />
            <Text style={styles.buttonText}>&nbsp;Shuttle Bus</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.buttonSquare,
              map.travalMode === "BICYCLING" && styles.buttonActive,
            ]}
            onPress={() => onTravalModePress("BICYCLING")}
          >
            <FontAwesome5
              name="bicycle"
              size={normalize(12)}
              ...
              return (
                <View
                  style={{
                    flexDirection: "row",
                    flex:
                      props.keyboardStatus && props.keyboardStatus === true
                        ? 0.7
                        : 0.5,
                  }}
                >
