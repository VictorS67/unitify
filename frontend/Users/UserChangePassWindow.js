...
import { Text, View, StyleSheet, TextInput, Button, Pressable, Alert, TouchableOpacity } from 'react-native';
...
const UserChangePassWindow = props => {
    ...
    const changePasswordHandler = (event) => {
        ...
        if (oldPass !== "" && newPass !== "" && newPassAgain !== "") {
            dispatch(changePassword(user.id, oldPass, newPass, newPassAgain))
            .then(
                (resolve) => {
                    resetPassword();
